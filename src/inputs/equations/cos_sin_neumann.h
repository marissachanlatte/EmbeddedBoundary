#ifndef EMBEDDED_BOUNDARY_SRC_INPUTS_EQUATIONS_COS_SIN_NEUMANN_H
...
class CosSinNeumann : public SolverInputBase{
  public:
    ~CosSinNeumann() = default;
...
#endif // EMBEDDED_BOUNDARY_SRC_INPUTS_EQUATIONS_COS_SIN_NEUMANN_H
